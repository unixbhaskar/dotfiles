...
alias see_log='sudo tail -f /var/log/messages | ccze || journalctl -f -q 2>/dev/null'
alias gitlog=gitlog
...
alias gentoo_useflags="emerge --info | grep ^USE"
...
alias kbuild_pull="cd ~/git-linux/kbuild/ &&  git pull origin kbuild-next"
