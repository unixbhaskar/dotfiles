...
* To copy dot emacs and this org file to dotfile repo and local backup folder after edit and save
#+begin_src emacs-lisp
...
* Make a window frame full screen then come back grid
#+begin_src emacs-lisp
(defun toggle-maximize-buffer () "Maximize buffer"
  ...
  (if (= 1 (length (window-list)))
    ...
    (progn
      ...
      (delete-other-windows))))
(global-set-key (kbd "C-c f") 'crux-transpose-windows)
#+end_src
