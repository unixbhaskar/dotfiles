...
(use-package org-fancy-priorities
  12  :diminish
  11  :demand t
  10  :defines org-fancy-priorities-list
   9  :hook (org-mode . org-fancy-priorities-mode)
   8  :config
   7  (unless (char-displayable-p ?❗)
   6  (setq org-fancy-priorities-list '("HIGH" "MID" "LOW" "OPTIONAL"))))
#+end_src
